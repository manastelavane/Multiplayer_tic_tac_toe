import { CHECK_MAIL_FAIL, CREATE_ROOM, CREATE_ROOM_FAIL, LOADING, GET_ROOM, GET_ROOM_FAIL, GET_ALL_ROOMS} from '../constants/actionTypes';
...
export const getroom= (id) => async (dispatch) => {
    try {
    //   dispatch({type:CHECK_MAIL_LOADING})
    //   console.log(formData)
    dispatch({type:LOADING})
