    ...
    <div className='roomcontainer'>
        <h2>Your Game</h2>
      {
        ...
        <div className='roomszero'>
            ...
            <button onClick={()=>navigate('/intermediateroom')} className='allrooms-register1'>Start a new game</button>
            </div>
        </div>:
        <div className='roomsnonzero'>
            {
                allrooms!==null && allrooms?.length!==0 && allrooms?.map((room,index)=>{
                    return(
            ...
            <div className='fixed-new-game' onClick={()=>navigate('/intermediateroom')}>
